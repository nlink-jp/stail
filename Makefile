...
.PHONY: build build-all package verify-release test lint clean tidy help
...
BREW_KIND := formula
BREW_DESC := Read-only Slack CLI that streams and exports messages like tail -f
